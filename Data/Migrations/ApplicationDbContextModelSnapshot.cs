...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Invoice_system.Models.StockDetail", b =>
                {
                    ...
                    b.Property<DateTime?>("date_of_expiry")
                        .HasColumnType("datetime2")
                        .HasColumnName("date_of_expiry");

                    b.Property<DateTime?>("date_of_manafacture")
                        .HasColumnType("datetime2")
            ...
            modelBuilder.Entity("E_Invoice_system.Models.ProductService", b =>
                {
                    b.HasOne("E_Invoice_system.Models.Brand", null)
                        .WithMany()
                        .HasForeignKey("brand_id")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("E_Invoice_system.Models.Category", null)
                        .WithMany()
